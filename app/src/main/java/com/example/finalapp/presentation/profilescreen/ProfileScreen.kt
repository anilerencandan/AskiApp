package com.example.finalapp.presentation.profilescreen
...
@Composable
fun ProfileScreen(navController: NavController, vm: AskiViewModel) {
...
@Composable
fun ProfileImage(imageUrl: String?, vm: AskiViewModel) {
